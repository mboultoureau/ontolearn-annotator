...
const colors = [
    ...
    },
    {
        ...
        value: "Multiple irregulars 1",
        outerColor: "#26de81",
        innerColor: "#26de8122"
    },
    {
        label: "Multiple irregulars 2",
        value: "Multiple irregulars 2",
        outerColor: "#4b7bec",
        innerColor: "#4b7bec22"
    },
    {
        label: "Multiple irregulars 3",
        value: "Multiple irregulars 3",
        outerColor: "#eb3b5a",
        innerColor: "#eb3b5a22"
    },
    {
...
export default function ImageSegmentation() {
    ...
    useEffect(() => {
        const viewerInstance = OpenSeadragon({
            ...
            tileSources: "/datasets/case_19.dzi",
    ...
    const onNextTask = () => {
        ...
        toast({
            ...
            description: (
                <pre className="mt-2 w-[340px] max-h-[500px] rounded-md bg-slate-950 p-4 overflow-scroll">
    ...
    return (
        <>
            ...
            <div className="relative h-full w-full mr-2 mb-2">
                <Overlay
